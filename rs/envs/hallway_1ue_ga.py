...
from rs.envs.engine_ma import AutoRestartManager, SignalCoverage
import copy
import numpy as np
...
class Hallway1UEGA(EnvBase):
    ...
    def _reset(self, tensordict: TensorDict = None, **kwargs) -> TensorDict:
        ...
        self.cur_rss = torch.zeros((1, 1, self.n_targets), dtype=torch.float32, device=self.device)
    ...
    def _step(self, tensordict: TensorDict) -> TensorDict:
        ...
        self.focals = tensordict["agents", "action"]
