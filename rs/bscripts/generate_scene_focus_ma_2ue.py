...
def generate_scene(args):
    ...
    # merge tiles groups with odd and even indices
    # e.g. Group01.001, Group01.002, ..., Group01.009 with Group03.001, Group03.002, ..., Group03.009
    # and Group02.001, Group02.002, ..., Group02.009 with Group04.001, Group04.002, ..., Group04.009
    # to have
    # 2 groups of tiles: Group01, 03, 05, 07, 09 and Group02, 04, 06, 08
    tile_groups = [
        tile_groups[0] + tile_groups[2] + tile_groups[4] + tile_groups[6] + tile_groups[8],
        tile_groups[1] + tile_groups[3] + tile_groups[5] + tile_groups[7],
    ]
