...
python ./main_1ue_ma.py --command "train" --env_id "outdoor_focus_ma" --checkpoint_dir $SOURCE_DIR/local_assets/outdoor_focus_small --sionna_config_file $SOURCE_DIR/configs/sionna_outdoor_focus_ma_small.yaml --source_dir $SOURCE_DIR --num_envs 5 --group "PPO_Hallway_L" --name "outdoor_focus_small" --track_wandb False
