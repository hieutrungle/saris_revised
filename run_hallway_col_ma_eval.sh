...
python ./main_1ue_ma.py --command "eval" --env_id "hallway_col_ma" --checkpoint_dir $SOURCE_DIR/local_assets/hallway_col_eval --sionna_config_file $SOURCE_DIR/configs/sionna_hallway_col_ma.yaml --source_dir $SOURCE_DIR --num_envs 4 --group "PPO_Hallway_L" --name "hallway_col_eval" --wandb "offline" --image_dir $SOURCE_DIR/local_assets/hallway_col_eval/images 
# --ep_len 8 --frames_per_batch 8 --n_iters 1 --num_epochs 2 --minibatch_size 2 --total_episodes 2