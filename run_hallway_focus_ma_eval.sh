...
python ./main_1ue_ma.py --command "eval" --env_id "hallway_focus_ma" --checkpoint_dir $SOURCE_DIR/local_assets/hallway_focus_eval --sionna_config_file $SOURCE_DIR/configs/sionna_hallway_focus_ma.yaml --source_dir $SOURCE_DIR --num_envs 1 --group "PPO_Hallway_L" --name "hallway_focus_eval" --ep_len 20 --image_dir $SOURCE_DIR/local_assets/hallway_focus_eval/images --wandb "offline"
