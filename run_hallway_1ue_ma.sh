...
python ./main_1ue_ma.py --command "train" --env_id "hallway_1ue_ma" --checkpoint_dir $SOURCE_DIR/test_local_assets/hallway_1ue_ma --sionna_config_file $SOURCE_DIR/configs/sionna_hallway_1ue_ma.yaml --source_dir $SOURCE_DIR --num_envs 4 --group "PPO_Hallway_L" --name "AdvNorm_Hallway_1ue_ma" --ep_len 2 --frames_per_batch 4 --n_iters 10 --num_epochs 2 --minibatch_size 4 --wandb "offline" --seed 2  --no_allocator True
